...
function SbLink({
  ...
  return (
    <Link
      href={href}
      onClick={onClick}
      className={`flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm transition-all duration-150 cursor-pointer relative ${active ? 'font-semibold' : 'font-medium'}`}
      style={{
    ...
    <div className="flex min-h-screen" style={{ background: 'var(--ls-bg)' }}>
      ...
      >
        ...
        <div className="flex items-center justify-between px-4 h-16 shrink-0" style={{ borderBottom: '1px solid var(--ls-sb-border)' }}>
          <Link href="/dashboard/tracks" className="flex items-center gap-2.5 min-w-0">
            ...
            <span
              className="text-base font-bold tracking-tight truncate text-white"
          ...
          {user?.role === 'ADMIN' && (
            <div className="pt-4 mt-2" style={{ borderTop: '1px solid var(--ls-sb-border)' }}>
              ...
              <Link
                ...
                style={{ color: 'var(--ls-sb-muted)', borderLeft: '3px solid transparent' }}
                onMouseEnter={(e) => {
      ...
      <div className="flex flex-col flex-1 min-w-0">
        ...
        >
          ...
          <Link href="/dashboard/tracks" className="flex items-center gap-2 flex-1 min-w-0">
